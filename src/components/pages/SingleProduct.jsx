...
const SingleProduct = () => {
    ...
    return (
        <Container>
            <Row>
                <Col md={6} className="p-4 mt-5 bg-black border border-secondary rounded-4 mx-auto">
                        ...
                        isloading ?
                            ...
                            : <div className="d-flex flex-wrap align-items-center justify-content-center">
                                <Col lg={6} xs={12} className="p-4">
                                    <img className="object-fit-cover" style={{ width: '100%', aspectRatio: '1/1' }} src={shopImg} alt="" />
                                </Col>
                                <Col lg={6} xs={12}>
                                    <ListGroup>
                                        {
                                            ['name', 'id', 'category', 'price', 'quantity', 'description'].map((feild, index) => {
                                                return (
                                                    <ListGroup.Item key={index} className="text-white">
